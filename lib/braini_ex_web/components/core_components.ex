defmodule BrainiExWeb.CoreComponents do
  @moduledoc """
  ...
  def simple_form(assigns) do
    ...
    <.form :let={f} for={@for} as={@as} {@rest}>
      <div class={["space-y-8 bg-white mt-10", @additional_classes]}>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BrainiExWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BrainiExWeb.Gettext, "errors", msg, opts)
    end
  end
